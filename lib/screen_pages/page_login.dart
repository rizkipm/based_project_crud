...
import 'package:uts_mobile_rpl/models/model_login.dart';
import 'package:uts_mobile_rpl/screen_pages/page_list_berita.dart';
import 'package:uts_mobile_rpl/screen_pages/page_register.dart';
...
class _PageLoginState extends State<PageLogin> {
  ...
  Future<ModelLogin?> loginAccount() async{
    try{
      ...
      http.Response res = await http.post(Uri.parse('http://192.168.100.252:8080/uts_mobile/login.php'),
          body: {
